#!/usr/bin/env bash
#SBATCH --job-name=ds-fp8-1p-tp8-1d-tp8
...
#SBATCH --output=/it-share/yajizhan/slurm_logs/ds_fp8_1p_tp8_1d_tp8-%j.out
#SBATCH --error=/it-share/yajizhan/slurm_logs/ds_fp8_1p_tp8_1d_tp8-%j.err
#
...
#   sbatch ds_fp8_1p_tp8_1d_tp8_slurm.sh
#
# Override defaults via env:
#   sbatch --export=ALL,LOAD_DUMMY=,ISL_LIST="1024,8192" ds_fp8_1p_tp8_1d_tp8_slurm.sh
...
LOG_ROOT="${LOG_ROOT:-/it-share/yajizhan/slurm_logs/$(date +%m%d)_ds_fp8_1p_tp8_1d_tp8_${SLURM_JOB_ID}}"
...
wait_grpc "$DECODE_NODE"  "${DECODE_IP}"  "${DECODE_PORT}" \
